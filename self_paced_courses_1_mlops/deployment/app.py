...
model_path = hf_hub_download(repo_id="kcharoensri/PIMA-Diabetes-Prediction", filename="best_pima_diabetes_model_v1.joblib")                                       # enter the Hugging Face username here
