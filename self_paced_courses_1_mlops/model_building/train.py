...
Xtrain_path = "hf://datasets/kcharoensri/PIMA-Diabetes-Prediction/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/kcharoensri/PIMA-Diabetes-Prediction/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/kcharoensri/PIMA-Diabetes-Prediction/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/kcharoensri/PIMA-Diabetes-Prediction/ytest.csv"                      # enter the Hugging Face username here
...
repo_id = "kcharoensri/PIMA-Diabetes-Prediction"                                         # enter the Hugging Face username here
repo_type = "model"
